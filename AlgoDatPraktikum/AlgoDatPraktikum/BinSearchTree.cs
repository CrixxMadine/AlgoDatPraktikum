...
namespace AlgoDatPraktikum  // Achtung noch Bug !!!!!! Lösche knotem -> right -> left lösche Knoten, bug
{
    class BinSearchTree : ISetSorted
    {
        ...
        protected virtual bool Insert(Node parent, int elem)
        {
        ...
        protected virtual bool Search(Node parent, int elem)
        {
            if (parent == null)
                return false;
            if (parent.value > elem)
        ...
        protected virtual bool Delete(Node parent, int elem)
        {
            if (parent == null)
                return false;
